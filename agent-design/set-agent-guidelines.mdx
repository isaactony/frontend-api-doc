---
title: "Setting Agent Guidelines"
icon: "user-cog"
...
## Step 1: Access the Agent Guidelines
...
## Step 2: Understand What Guidelines Do
...
## Step 3: Build Your Guidelines Structure
...
<Steps>
  ...
  <Step title=" Handling Specific Scenarios">
    Define how the AI should behave in sensitive or special situations.

    **Example: Handling an Unhappy Customer (The LEARN Framework)**
...
## Step 4: When to Use Guidelines vs Knowledge Base
