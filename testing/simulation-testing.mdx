...
![Create Simulated Test Case Pn](/assets/create-simulated-test-case.png)
...
You simply select any past call and link it to a test case. Phonely replays the transcript during the simulated test. If the list is empty, it means no calls have yet been logged for that agent.
