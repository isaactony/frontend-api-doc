...
<Steps>
  ...
  <Step title="Integration Testing">
    ...
    **Block connections:** Verify that blocks connect properly and data flows correctly between them.

    **Conditional Logic:** Test all possible paths through your flow, including edge cases.

    **External systems:** Ensure integrations with databases, APIs, and other services work as expected.
  </Step>
...
<Check>
  Test plan documentation with clear objectives
</Check>
...
<CardGroup cols={2}>
  <Card title="Flow Design" icon="pen-tool" href="/best-practices/flow-design">
