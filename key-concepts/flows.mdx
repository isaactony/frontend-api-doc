...
<Info>
  <b>Versioning:</b> Every save is a version. You can revert. Always test before pushing to production.
</Info>
...
<AccordionGroup>
  ...
  <Accordion title="How to set variables">
    ...
    blocks for caller input, <b>
     API Request</b>

    blocks for external data, or add custom variables via the Variable modal.
  </Accordion>
  <Accordion title="How to access variables">
    Reference by name with <code>
     @variable_name</code>

    or select from the Variable modal. Use them in prompts, conditions, and API payloads.
  </Accordion>
</AccordionGroup>
...
<Card title="Automatic">
  System applies defaults like <code>
   completed</code>
...
<Card title="Custom">
  Set custom tags in <b>
   End Call</b>

  blocks for downstream workflows.
</Card>
