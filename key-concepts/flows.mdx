...
### 1. Blocks (Steps in the Conversation)
...
Phonely includes several canvas tools to help you navigate and organize large flows.
...
[_See the dedicated Canvas Navigation & Editing Tools guide for full details._](/key-concepts/flow-canvas-controls)

## Why Use Flows?

Flows allow you to:

- Build and update conversational logic without engineering support
- Handle interruptions, clarifications, backtracking, and pivots gracefully
- Scale confidently across thousands of concurrent calls
- Integrate directly with your systems through API requests
- Iterate quickly with versioning and safe publishing

## Core Concepts

### How to Create a Flow

1. **Open your Flow** and click **Edit**. This enters editing mode.
2. **Add blocks**\
   **Click the “+” node** between existing blocks or at the end of a chain to insert a new block.
