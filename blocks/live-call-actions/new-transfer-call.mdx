...
Let’s build a real example matching Will’s video:

### Scenario

Caller wants to reach someone in the support team.

### Setup

Choose **Warm Transfer**.
...
With this one transfer block, you completely replace the giant, messy flow shown in the video.
