...
<Steps>
  <Step title="Access the Workflows Page">
    1. Log in to the Phonely Dashboard. 
  ...
  <Step title="Add a Phone Number Request (Crucial for Reliability)">
  ...
  <Step title="Add the Send Text Message Block">
  ...
  <Step title="Configure the SMS">
    Click on the Send Text Message Block to open its settings.
  </Step>
</Steps>
