...
<Steps>
  ...
  <Step title="Configure the Email Content">
    ...
    **Dynamic Content**
    ...
    | **Body**                            | Compose your message. You can include variables, such as:`Caller Name: {{caller_name}}`<br />- `Email: {{caller_email}}`<br />- `Phone: {{caller_phone}}`<br />- `Summary: {{summary}}`<br />- `Recording: {{dashboard_url}}` |
