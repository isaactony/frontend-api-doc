...
Click **Sync Column Names** to automatically load all column headers from your sheet.

This ensures your row data maps correctly to the right columns.

## 5. Map Columns to Flow Variables
...
2. Choose a variable from the left-side **Available Variables** panel.
   - Examples:
     ...
     - `order_number`
     - `email_address`
3. Or type a static value (e.g., “New lead”).
...
> “Please hold while I save your details.”
...
## **7. Test the Google Sheets Write Action**
...
- A real row is added to your Google Sheet.

You can click **Open Sheet** to confirm.
