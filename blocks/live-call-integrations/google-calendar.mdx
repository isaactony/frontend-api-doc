...
<Steps>
  <Step title=" Add Google Calendar to Your Flow" titleSize="h2">
  ...
  <Step title="Choose an Action" titleSize="h2">
  ...
  <Step title="Connect Your Google Account" titleSize="h2">
  ...
  <Step title="Verify and Continue" titleSize="h2">
  ...
  <Step title="Configure the Google Calendar block" titleSize="h2">
  ...
  <Step title="Test the configuration" titleSize="h2">
    ...
    ![Availability Tests Pn](/assets/availability-tests.png)
    ...
    ![Appointments Test Pn](/assets/appointments-test.png)
  </Step>
</Steps>
