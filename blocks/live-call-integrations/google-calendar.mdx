...
The **Custom Google Calendar block** in Phonely is a powerful yet simplified integration that allows your AI phone agent to:

- **Check availability**
- **Present open appointment slots to callers**
- **Create appointments directly in your connected Google Calendar**

Unlike earlier versions—where you had to manually chain multiple blocks, manage variable extraction, and connect prompt blocks—the new integration **bundles all required logic into a single, self-contained block** that can be configured in minutes.

For advanced users, the block can be expanded and edited into a full workflow group, giving full control over prompts, logic, and variables.     
