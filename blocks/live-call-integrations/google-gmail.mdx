...
title: "Connecting a Gmail Account in Phonely"
---
...
## Add the Gmail Action to Your Flow

1. In your flow editor, locate the point where you want to send an email.
2. Click the **➕ (plus)** icon under the block (for example, under a _Collect_ block).
3. A menu appears with two sections:
   - **Flow blocks** (like Talk, Collect, Ask Exactly)
   - **Live Call Actions**
4. From **Live Call Actions**, select **Gmail**.
...
4. Allow Phonely to access your Gmail for sending emails.
5. Once connected, you’ll see your Gmail account listed in the **Connection** dropdown.
...
![Connect Your Gmail Account Pn](/assets/connect-your-gmail-account.png)
...
Phonely will send an actual email to the address provided.

### Expected Result

You should see a confirmation:

In your Gmail inbox, the test message should look like this:
