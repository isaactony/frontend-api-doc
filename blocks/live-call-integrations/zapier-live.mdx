...
<Steps>
  ...
  <Step title=" Add a Zapier Block in Phonely" stepNumber={2}>
    ...
    Choose either **Live Call Actions** or **Post Call Actions** from the menu.

    <Note>
      While Live Call actions occur immediately, Post Call actions have access to more comprehensive call data (e.g., call recording, full transcript, call summary), making them valuable for many Zapier integrations.
    </Note>
  </Step>
