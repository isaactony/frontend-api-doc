...
<Steps>
  <Step title="Add a Time Filter Block">
    ...
    <img
      src="/assets/choosing-time-filter-block.png"
      alt="Choosing Time Filter Block Pn"
      title="Choosing Time Filter Block Pn"
      style={{ width:"82%" }}
    />
  </Step>
  ...
  <Step title="Define Outcome Paths">
    ...
    ![Timefilterphonely Pn](/images/timefilterphonely.png)
  </Step>
</Steps>
