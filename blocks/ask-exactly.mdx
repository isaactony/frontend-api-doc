...
<Steps>
  ...
  <Step title="Select the (+) node below the Start Flow block, or any existing block which you would like to add your Ask Exactly block below.">
  </Step>
  ...
  <Step title="Referencing Previous Answers">
    You can reference previously collected information (stored as variables) directly in your question. For instance, if a previous block asked for an address, you could phrase a confirmation question like: "Just to confirm, you said your address is [address variable]? Have you been here before?"
  </Step>
</Steps>
