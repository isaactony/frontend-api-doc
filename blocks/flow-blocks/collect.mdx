...
In this tutorial, we'll guide you through the Collect Block in Phonely, demonstrating how you can efficiently gather multiple pieces of information from a customer in a natural, conversational manner. 

![Howto Adda Collect Block Gi](/images/HowtoAddaCollectBlock.gif)
...
<Steps>
  <Step title="Add a New Block">
    In your workflow, click the **\+** button to add a new block.
  </Step>
  <Step title="Select Collect:">
    Choose the "Collect" option from the available blocks.
  </Step>
  <Step title="Configure Questions:">
    For each piece of information you need to gather, you will add a specific entry within the Collect Block's settings:
    ...
    - **Question (Instruction)**: Briefly describe what Phonely should ask or obtain from the customer (e.g., "Get customer name", "Get customer phone", "Get customer email"). This serves as an instruction to the AI agent

    <Tip>
      You can include specific instructions here, such as "Get the caller's name and spell it back to them
    </Tip>
    ![Collect Block In Phonely Pn](/assets/collect-block-in-phonely.png)
  </Step>
</Steps>
...
<img
  src="/assets/collect-block.png"
  alt="Collect Block Pn"
  title="Collect Block Pn"
  style={{ width:"82%" }}
/>
