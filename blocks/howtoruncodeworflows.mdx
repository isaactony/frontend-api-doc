...
The Code Block is a powerful new workflow that allows you to execute Python code directly within your Phonely workflows.
 ...
 It acts as a dynamic logic layer between conversational steps, giving you the ability to compute values, make conditional decisions, or trigger external behavior through your own scripts.
...
<Steps>
  ...
  <Step title="Configure Input Variables">
    ...
    For instance in this example the AI will ask the caller why they are calling and if they want o to be transferred to a store they will be asked to provide a zip_code. This zip code can be used as an imput variable in the code. 
  </Step>
  ...
  <Step title="How It Works">
    ...
    **Function Definition**
    ...
    You can think of this function as a self-contained “mini program” that takes workflow data, processes it, and gives back results.
