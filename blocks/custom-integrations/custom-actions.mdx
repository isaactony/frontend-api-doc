...
## Configuring a Custom Action - Appointment Example
...
- **Appointment Name: **Provide a name for the appointment.
...
![Make Appointment Custom Action New Pn](/assets/make-appointment-custom-action-new.png)
