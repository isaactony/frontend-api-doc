...
<Steps>
  ...
  <Step title="Click the ＋ buztton under any existing block.">
...
**Connect an API Request Block** Next, you’ll connect to your firm’s booking system or calendar API to check available slots.
