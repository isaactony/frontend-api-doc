...
<Steps>
  <Step title="Start from Your Flow" titleSize="h3">
    ...
    3. Select Build a Custom Action. A purple editor window opens -  his is your custom action workspace.
  </Step>
  ...
  <Step title="Publishing Your Custom Action" titleSize="h3">
  ...
  <Step title="Configure Customizable Fields" titleSize="h3">
  ...
  <Step title="Finalize the Integration details and Submit" titleSize="h3">
    ...
    5. Click **Submit** to finalize and publish.
       ...
       ![Create Custom Action Pn](/assets/create-custom-action.png)
  </Step>
